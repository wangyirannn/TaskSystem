var TaskPanel = (function () {
    function TaskPanel(stage, taskService) {
        this.backColor = 0xB8B8DC;
        this.panelX = 300;
        this.panelY = 100;
        this.panelWidth = 200;
        this.panelHeight = 300;
        this.taskNameTextFieldText = "任务";
        this.taskNameTextFieldX = 70;
        this.taskNameTextFieldY = 20;
        this.taskNameTextFieldWidth = 200;
        this.taskNameTextFieldHeight = 50;
        this.taskNameBackX = 0;
        this.taskNameBackY = 10;
        this.taskNameTextFieldColor = 0xFFAAD5;
        ...
        this.buttonTextFieldColor = 0xFFC1E0;
        this.stage = stage;
