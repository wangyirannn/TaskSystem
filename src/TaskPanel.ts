class TaskPanel implements Observer {
	...
	private taskNameTextFieldText = "任务";
	private taskNameTextFieldX = 70;
	private taskNameTextFieldY = 20;
	private taskNameTextFieldWidth = 200;
	private taskNameTextFieldHeight = 50;
	private taskNameBackX=0;
	private taskNameBackY=10;
	private taskNameTextFieldColor = 0xFFAAD5;
	...
	private buttonTextFieldColor = 0xFFC1E0;
	...
	private changeButton(taskStatus: number) {
		switch (taskStatus) {
			...
			case TaskStatus.SUBMITTED:
				this.taskNameTextField.text = "任务";
